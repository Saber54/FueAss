...
class PdfExportService {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 20),
              _buildMapInfo(center, zoom, isOfflineMode, showHydrants, hydrantCount, tacticalMarkerCount),
  ...
  pw.Widget _buildMapInfo(LatLng center, double zoom, bool isOfflineMode, bool showHydrants, int hydrantCount, int tacticalMarkerCount) {
    return pw.Container(
      width: double.infinity,
      padding: const pw.EdgeInsets.all(10),
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Text('Modus: ${isOfflineMode ? "Offline (Deutschland)" : "Online"}'),
          if (showHydrants) pw.Text('Hydranten: $hydrantCount angezeigt'),
          if (tacticalMarkerCount > 0) pw.Text('Taktische Marker: $tacticalMarkerCount'),
        ],
      ),
    );
  }
